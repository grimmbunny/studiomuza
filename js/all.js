(function ($) {
  ...
  function init_scroll_navigate() {
    ...
    var sections = $(
      ".home-section:not(.scroll-nav-invisible), .page-section:not(.scroll-nav-invisible)"
    );
    ...
    if (!!!isReduced) {
      if ($("html").hasClass("no-mobile")) {
        ...
        $(".parallax-mousemove-scene").on("mousemove", function (e) {
          ...
          $(this)
            .find(".parallax-mousemove-follow")
            .each(function (i, el) {
              $(el).css({
                left: offsetX,
                top: offsetY,
  ...
  function init_text_rotator() {
    $(".text-rotate").each(function () {
      ...
      text_rotator.before(
        "<span class='visually-hidden'>" + text_rotator_cont + "</span>"
      );
  ...
  function init_team() {
    $(".team-carousel").each(function () {
      $(this).css(
        "--team-item-descr-height",
        $(this).find(".team-item-descr").height() + "px"
      );
    });
  ...
  function init_split_section() {
    var split_column_padding =
      ($(window).width() - $(".container").first().width()) / 2;
  ...
  (function ($) {
    ...
    function owl_keynav(el) {
      ...
      if (el.hasClass("autoplay")) {
        el.prepend(
          "<button class='owl-pause-button visually-hidden sr-only'>Stop Sliding</button>"
        );
    ...
    $(".testimonials-slider-1").owlCarousel({
      ...
      addClassActive: true,
      navigationText: [
        '<span class="visually-hidden">Previous Slide</span><i class="mi-arrow-left" aria-hidden="true"></i>',
        '<span class="visually-hidden">Next Slide</span><i class="mi-arrow-right" aria-hidden="true"></i>',
      ],
      afterInit: owl_keynav,
      afterAction: owl_update,
    });
...
function init_bg_video() {
  (function ($) {
    $(".bg-video-button-muted").click(function () {
      if (
        $(this).prevAll(".bg-video-wrapper").find(".bg-video").prop("muted")
      ) {
        $(this)
          .prevAll(".bg-video-wrapper")
          .find(".bg-video")
          .prop("muted", false);
        $(this).html(
          '<i class="mi-volume-up"></i> <span class="visually-hidden">Volume Off</span>'
        );
      } else {
        $(this)
          .prevAll(".bg-video-wrapper")
          ...
          .prop("muted", true);
        $(this).html(
          '<i class="mi-volume-off"></i> <span class="visually-hidden">Volume On</span>'
        );
      }
    ...
    $(".bg-video-button-pause").each(function () {
      setTimeout(() => {
        if ($(this).prevAll(".bg-video-wrapper").find(".bg-video")[0].paused) {
          $(this).html(
            '<i class="mi-play"></i> <span class="visually-hidden">Play</span>'
          );
        }
      }, "1000");
      setTimeout(() => {
        if (!$(this).prevAll(".bg-video-wrapper").find(".bg-video")[0].paused) {
          $(this).html(
            '<i class="mi-pause"></i> <span class="visually-hidden">Pause</span>'
          );
        }
      }, "1500");
      setTimeout(() => {
...
function init_text_outline() {
  (function ($) {
    $(".text-outline").each(function () {
      ...
      text_outline.before(
        "<span class='text-outline-2' aria-hidden='true'>" +
          text_outline_cont +
          "</span>"
      );
      text_outline.before(
        "<span class='text-outline-1' aria-hidden='true'>" +
          text_outline_cont +
          "</span>"
      );
    });
...
function init_btn_animation() {
  (function ($) {
    $("[data-btn-animate=y]").each(function () {
      ...
      btn_animate_y.html(
        '<span class="btn-animate-y"><span class="btn-animate-y-1">' +
          btn_animate_y_cont +
          '</span><span class="btn-animate-y-2" aria-hidden="true">' +
          btn_animate_y_cont +
          "</span></span>"
      );
    });
    ...
    $("[data-btn-animate=ellipse]").each(function () {
      ...
      btn_animate_ellipse.html(
        '<span class="btn-ellipse-inner"><span class="btn-ellipse-unhovered">' +
          btn_animate_ellipse_cont +
          '</span><span class="btn-ellipse-hovered" aria-hidden="true">' +
          btn_animate_ellipse_cont +
          "</span></span>"
      );
    });
    ...
    $("[data-link-animate=y]").each(function () {
      ...
      link_animate_y.html(
        '<span class="link-strong link-strong-unhovered">' +
          link_animate_y_cont +
          '</span><span class="link-strong link-strong-hovered" aria-hidden="true">' +
          link_animate_y_cont +
          "</span></span>"
      );
    });
...
$(window).on("load", function () {
  (function () {
    let getIcons = document.querySelectorAll(
      'i[class^="mi-"], i[class^="icon-"], i[class^="fa-"]'
    );
